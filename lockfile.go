...
// NewLockfile describes a new filename located at the given absolute path.
...
func (l Lockfile) TryLock() error {
	...
	// This has been checked by NewLockfile already. If we trigger here,
	// the caller didn't use NewLockfile and re-implemented it's functionality badly.
